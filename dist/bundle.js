...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_hoist_non_react_statics__ = __webpack_require__(55);
...
var _commonFunc = __webpack_require__(58);
...
var _labeledInput = __webpack_require__(46);
...
var _sharedStyledComponents = __webpack_require__(7);

var _datetimeInput = __webpack_require__(70);

var _datetimeInput2 = _interopRequireDefault(_datetimeInput);

var _closePopupListener = __webpack_require__(17);
...
var GenericForm = function (_React$PureComponent) {
	...
	_createClass(GenericForm, [{
				...
				case 'number':
					{
						...
						ret = _react2.default.createElement(_labeledInput2.default, _extends({}, formItem, {
				...
				case 'dropdown':
					{
						...
						ret = _react2.default.createElement(_dropdown2.default, _extends({}, formItem, {
							setItem: this.setItem }));
						break;
					}
				...
				case 'checkbox':
					{
						...
						ret = _react2.default.createElement(_checkbox2.default, _extends({}, formItem, {
				...
				case 'autocomplete':
					{
						...
						ret = _react2.default.createElement(_autocomplete2.default, _extends({}, formItem, {
							setItem: this.setItem }));
						break;
					}
				...
				case 'select':
					{
						...
						ret = _react2.default.createElement(_select2.default, _extends({}, formItem, {
							setItem: this.setItem }));
						break;
					}
				...
				case 'radiogroup':
					{
						...
						ret = _react2.default.createElement(_radioButtonGroup2.default, _extends({}, formItem, {
							setItem: this.setItem }));
						break;
					}
				...
				case 'datetime':
					{
						...
						ret = _react2.default.createElement(_datetimeInput2.default, _extends({}, formItem, {
							setItem: this.setItem }));
						break;
					}
		...
		value: function render() {
			...
			return _react2.default.createElement(CSSVariables, _colorConfig2.default, _react2.default.createElement(FormWrapper, null, _react2.default.createElement(InputWrapper, null, formHtml), _react2.default.createElement(ButtonsWrapper, null, buttonsHtml)));
		}
	}]);
...
var _debounce = __webpack_require__(59);

var _debounce2 = _interopRequireDefault(_debounce);

var _keyPressHandlerOnList = __webpack_require__(27);
...
var _timepicker = __webpack_require__(71);
